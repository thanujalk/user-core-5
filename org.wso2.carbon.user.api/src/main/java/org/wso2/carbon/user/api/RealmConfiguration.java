...
public class RealmConfiguration {
    ...
    public boolean isRestrictedDomainForSlefSignUp(String domain) {
        if (restrictedDomainsForSelfSignUp.contains(domain.toUpperCase(Locale.getDefault()))) {
            return true;
        }
        return false;
    }
    ...
    public boolean isReservedRoleName(String roleName) {
        if (reservedRoleNames.contains(roleName.toUpperCase(Locale.getDefault()))) {
            return true;
        }
        return false;
    }
    ...
    public void addRestrictedDomainForSelfSignUp(String domain) {
        if (domain != null) {
            restrictedDomainsForSelfSignUp.add(domain.toUpperCase(Locale.getDefault()));
        }
    }

    public void addReservedRoleName(String roleName) {
        if (roleName != null) {
            reservedRoleNames.add(roleName.toUpperCase(Locale.getDefault()));
        }
    }
